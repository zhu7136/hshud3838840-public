#!/usr/bin/env python
"""Convert Drake G1 qpos/fps npz to holosoma format.

Uses holosoma's exact body_names and joint_names from motion_crawl_slope.npz.
"""
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: python convert_to_holosoma.py <input.npz> [output.npz]")
        sys.exit(1)
