...
class IsaacSim(BaseSimulator):
    ...
    def _setup_scene(self) -> None:
        ...
        if terrain_state.mesh_type == "plane":
            ...
            if os.path.exists(platform_path) and os.path.exists(tall_box_path):
                # Load platform (red)
                platform_mesh = trimesh.load(platform_path, force="mesh")
                create_prim_from_mesh(terrain_prim_path, platform_mesh,
                ...
                print(f"[INFO] Loaded platform (red): {platform_path}")
