...
setup(
    ...
    entry_points={
        "holosoma.sdk": [
            ...
            "limx = holosoma_inference.sdk.limx:LimxSimInterface",
        ],
        "holosoma.config.robot": [
            ...
            "hu-d04-29dof = holosoma_inference.config.config_values.robot:hu_d04_29dof",
        ],
        "holosoma.config.inference": [
            ...
            "hu-d04-29dof-loco = holosoma_inference.config.config_values.inference:hu_d04_29dof_loco",
            "hu-d04-29dof-wbt = holosoma_inference.config.config_values.inference:hu_d04_29dof_wbt",
        ],
        "holosoma.config.observation": [
            "loco-hu-d04-29dof = holosoma_inference.config.config_values.observation:loco_hu_d04_29dof",
        ],
    },
